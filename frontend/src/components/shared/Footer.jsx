...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-gray-200 py-8 text-gray-700">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          {/* Branding */}
          <div className="text-center md:text-left">
            <h2 className="text-2xl font-bold text-gray-900">Job<span className="text-[#6A38C2]">Portal</span></h2>
